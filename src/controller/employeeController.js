...
module.exports = { postNewTypeEmployee, getAllTypeEmployee, updateTypeEmployee, deleteTypeEmployee, postNewEmployee, getEmployeeById, getAllEmployee, deleteEmployee };
